...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="/notification-add" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('message') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('message') ? ' is-invalid' : '' }}" name="message" id="input-message" type="text" placeholder="{{ __('Message') }}" required="true" aria-required="true" />
